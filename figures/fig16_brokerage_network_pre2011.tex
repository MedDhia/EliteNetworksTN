...
\begin{figure}[t]
  ...
  Node area is proportional to betweenness centrality. The 198
  entities shown, joined by 264 ties, are the giant
  component of the subgraph induced on the 200 highest
  betweenness entities, which together hold 79.0\% of
...
% ---------------------------------------------------------------------
% A node-link diagram of 198 entities connected by
% 264 lines, drawn in greyscale. Circles are natural
