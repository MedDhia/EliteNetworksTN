...
| WARN | `unclassified_entities` | 16 | entities whose type could not be determined; add them to config/entity_overrides.csv |
...
| INFO | `size` |  | 4470 entities, 14418 observed edges, 35542 panel rows |
| INFO | `referential_integrity` |  | all edge endpoints resolve to an entity |
| INFO | `ownership_sum_distribution` |  | median declared blockholder coverage: 69.7% of capital |
| INFO | `duplicate_edges` | 986 | identical ties reported by more than one filing (expected; keep for provenance) |
| INFO | `entity_types` |  | aggregate=14, firm=2888, fund=33, person=1488, state=31, unknown=16 |
| INFO | `alias_merging` |  | 578 entities merged from >1 spelling |
...
| INFO | `layer:board_interlock` |  | 1994-2026, 23 years, 5387 edges |
| INFO | `layer:board_seat` |  | 1994-2026, 26 years, 2337 edges |
| INFO | `layer:board_seat_corporate` |  | 1994-2025, 25 years, 1632 edges |
...
| INFO | `layer:group_participation` |  | 2001-2026, 19 years, 991 edges |
| INFO | `layer:ownership` |  | 2006-2025, 20 years, 677 edges |
