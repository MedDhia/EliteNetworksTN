...
| WARN | `unclassified_entities` | 15 | entities whose type could not be determined; add them to config/entity_overrides.csv |
...
| INFO | `size` |  | 4358 entities, 14244 observed edges, 34980 panel rows |
| INFO | `referential_integrity` |  | all edge endpoints resolve to an entity |
| INFO | `ownership_sum_distribution` |  | median declared blockholder coverage: 70.0% of capital |
| INFO | `duplicate_edges` | 972 | identical ties reported by more than one filing (expected; keep for provenance) |
| INFO | `entity_types` |  | aggregate=14, firm=2817, fund=31, person=1451, state=30, unknown=15 |
| INFO | `alias_merging` |  | 569 entities merged from >1 spelling |
...
| INFO | `layer:board_interlock` |  | 1994-2026, 23 years, 5384 edges |
| INFO | `layer:board_seat` |  | 1994-2026, 26 years, 2267 edges |
| INFO | `layer:board_seat_corporate` |  | 1994-2025, 25 years, 1565 edges |
...
| INFO | `layer:group_participation` |  | 2001-2026, 19 years, 975 edges |
| INFO | `layer:ownership` |  | 2006-2025, 20 years, 660 edges |
